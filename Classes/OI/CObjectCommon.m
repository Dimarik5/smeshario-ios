...
-(void)load:(CFile*)file withType:(short)type andCOI:(COI*)pOi;
{
	...
	int oExtension=[file readAUnsignedShort];	    // WORD Extension structure
	int oMovements=[file readAUnsignedShort];	    // WORD Offset of the movements
	[file skipBytes:2];			    // WORD For version versions > MOULI
	int oCounter=[file readAUnsignedShort];             // WORD Pointer to COUNTER structure
	int oAnimations=[file readAUnsignedShort];	    // WORD Offset of the animations
	int oData=[file readAUnsignedShort];		    // WORD Pointer to DATA structure
	...
	[file skipBytes:2];
	int oValues=[file readAUnsignedShort];		    // WORD Values structure
	int oStrings=[file readAUnsignedShort];             // WORD String structure
