...
#define PROFILE_BEGIN() CFTimeInterval __start = CACurrentMediaTime()
#define PROFILE_END(msg) NSLog(@"%s %@ took %.6f ms", __PRETTY_FUNCTION__, msg, (CACurrentMediaTime() - __start) * 1000.0)
