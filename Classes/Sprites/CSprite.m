...
-(void)draw:(CRenderer*)renderer
{
	...
	{       
		...
		renderer->renderScaledRotatedImage(toDraw, sprAngle, sprScaleX, sprScaleY, hsx, hsy, sprX, sprY, toDraw->originalWidth, toDraw->originalHeight, sprEffectShader, sprEffect, sprEffectParam);
	}
}
