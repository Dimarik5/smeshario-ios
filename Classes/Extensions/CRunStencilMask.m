...
-(BOOL)createRunObject:(CFile*)file withCOB:(CCreateObjectInfo*)cob andVersion:(int)version
{
	...
	for (int n=0; n<numImages; n++)
		images[n] = [file readAUnsignedShort];
...
-(void)displayRunObject:(CRenderer *)renderer
{
	switch (stencilMode)
	{
		...
		case 1:		//Mask outside
		{
            ...
            // passing -1 as shaderindex since it is already binded as shader
			renderer->renderImage(image, [ho getX], [ho getY], [ho getWidth], [ho getHeight], -1, 0, 0);
